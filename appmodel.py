from pyautogui import press, typewrite, hotkey, time
import keyboard
import random
...
def on_press(key):
    try:  # used try so that if user pressed other than the given key error will not be shown
        ...
        if keyboard.is_pressed('a') or keyboard.is_pressed('e') or keyboard.is_pressed('i') or keyboard.is_pressed('o') or keyboard.is_pressed('u') or keyboard.is_pressed('s') or keyboard.is_pressed('y') or keyboard.is_pressed('r') or keyboard.is_pressed('backspace') or keyboard.is_pressed('delete') :
